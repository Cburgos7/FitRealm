module.exports = {
  expo: {
    ...
    plugins: [
      ...
      // Phase 2: native GPS + build config
      // (react-native-health iOS HealthKit still deferred — A1 risk)
      // (react-native-health-connect uses runtime require — no plugin needed)
      '@rnmapbox/maps',
      [
        'expo-location',
        {
